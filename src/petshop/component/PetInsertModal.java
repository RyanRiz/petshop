...
public class PetInsertModal extends javax.swing.JFrame {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAddActionPerformed
        try{
            ...
            String customer = "SELECT id FROM customers WHERE name = ?";
            String sql = "INSERT INTO pets (name, breed, color, age, description, customer_id) VALUES (?, ?, ?, ?, ?, ?)";

            java.sql.Connection conn = (java.sql.Connection) petshop.config.Database.configDB();

            java.sql.PreparedStatement pst = conn.prepareStatement(customer);
